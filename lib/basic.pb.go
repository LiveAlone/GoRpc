...
func (x *DemoProject) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DemoProject) ProtoMessage() {}

func (x *DemoProject) ProtoReflect() protoreflect.Message {
	mi := &file_basic_proto_msgTypes[0]
...
// Deprecated: Use DemoProject.ProtoReflect.Descriptor instead.
func (*DemoProject) Descriptor() ([]byte, []int) {
	return file_basic_proto_rawDescGZIP(), []int{0}
}

func (x *DemoProject) GetFirst() string {
	if x != nil {
		return x.First
	}
	return ""
...
var file_basic_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x69, 0x63, 0x22, 0x23, 0x0a, 0x0b, 0x44, 0x65, 0x6d, 0x6f, 0x50, 0x72, 0x6f, 0x6a,
	0x65, 0x63, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x66, 0x69, 0x72, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x66, 0x69, 0x72, 0x73, 0x74, 0x42, 0x04, 0x5a, 0x02, 0x2e, 0x2f, 0x62,
...
var file_basic_proto_goTypes = []interface{}{
	(*DemoProject)(nil), // 0: basic.DemoProject
}
